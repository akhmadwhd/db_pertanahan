                ...
                <div class="col-2">
                    <div class="sidebar container">
                        ...
                        <div class="sidebar container">
                            ...
                            <div class="d-grid gap-2 mt-5">
                                <a href="<?= base_url('Admin/LogoutController'); ?>">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                        <h5 class="text-bold fs-3 fw-bold">Data Ganti Rugi Lahan</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="#">Nama Instansi</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#">Nama Pemilik</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#">Bukti Alas Hak</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#">Nilai Total Ganti Rugi</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="#">Lokasi Lahan</a>
                                            </li>
                                            <li>
                            ...
                            <table class="table text-center">
                                <thead>
                                    <tr style="height: 35px;">
                                        ...
                                        <th scope="col" style="width: 180px;">Nama Instansi</th>
                                        <th scope="col" style="width: 180px;">Nama Pemilik</th>
                                        <th scope="col" style="width: 180px;">Bukti Alas Hak</th>
                                        <th scope="col" style="width: 180px;">Nilai Total Ganti Rugi</th>
                                        <th scope="col" style="width: 180px;">Lokasi Lahan</th>
                                        <th scope="col" style="width: 180px;">Keterangan</th>
