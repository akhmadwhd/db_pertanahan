...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="form-group">
      ...
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="level" id="bpk" value="BPK" checked="">
        <label class="form-check-label" for="petugas">BPK</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="level" id="petugasverifikasi" value="petugas verifikasi" checked="">
        <label class="form-check-label" for="petugas">Petugas Verifikasi</label>
      </div>
    </div>
